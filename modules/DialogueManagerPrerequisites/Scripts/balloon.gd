...
@onready var responses_example: Button = $Balloon/Responses/ResponsesMenu/ResponseExample
...
func play_sound(letter: String, _letter_index: int, _speed: float) -> void:
	if letter != " ":
		AudioManager.Play(soundName)

func change_fonts(font: FontFile) -> void:
	...
	###responses_example.add_theme_font_override("font", font)
